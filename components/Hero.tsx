    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="max-w-7xl mx-auto px-6 py-32 text-center">
        <h1 className="text-6xl font-bold text-gray-900 mb-4 animate-fade-in">
          Catalina Meneses Carmona
        </h1>
        <h2 className="text-3xl text-blue-600 font-semibold mb-6">
          Software Engineer
        </h2>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
          Software Engineer with over 9 years of experience building high-quality
          products across EdTech, FinTech, HealthTech, and monitoring systems.
